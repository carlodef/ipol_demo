...
echo "$distance -w $win_w -h $win_h -r $2 -R $3 input_1.png input_0_t$1.png disp_t$1.tif cost_t$1.tif dispR_t$1.tif costR_t$1.tif" 
$distance -w $win_w -h $win_h -r $2 -R $3 input_1_noised.png input_0_t$1.png disp_t$1.tif cost_t$1.tif dispR_t$1.tif costR_t$1.tif 
